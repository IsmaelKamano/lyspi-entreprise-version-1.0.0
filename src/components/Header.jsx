      ...
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-3">
          <div className="relative group">
            <img src="/premiere.jpeg" alt="LYSPI Logo" className="h-10 w-10 object-cover rounded-full ring-2 ring-white/20 transition-all duration-300 group-hover:ring-blue-400 group-hover:scale-110" />
            ...
            >
              ...
              <div className="text-center mb-8">
                <div className="relative inline-block">
                  <img src="/premiere.jpeg" alt="LYSPI Logo" className="h-16 w-16 rounded-full ring-4 ring-blue-400/30 mx-auto" />
